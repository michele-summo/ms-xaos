...
typedef unsigned char
    rgb_t[4]; /*4 is better than 3 - makes multiplying easier */
struct truec {
    ...
    unsigned int mask1, mask2,
        allmask;     /*Mask1 and mask2 are distinc color masks
...
#define interpol1(i1, i2, n, mask)                                             \
    ((((i1) & (mask)) * (n) + ((i2) & (mask)) * (256 - (n))) & ((mask) << 8))
#define interpol(i1, i2, n, mr, mg, mb)                                        \
    ((interpol1(i1, i2, n, mr) + interpol1(i1, i2, n, mg) +                    \
      interpol1(i1, i2, n, mb)) >>                                             \
     8)
...
#define safeinterpol(i1, i2, n, mr, mg, mb)                                    \
    ((((mr) | (mg) | (mb)) & 0xff000000)                                       \
         ? shiftinterpol(i1, i2, n, mr, mg, mb)                                \
         : interpol(i1, i2, n, mr, mg, mb))
#define interpoltype(palette, i1, i2, n)                                       \
    ((palette).type == GRAYSCALE || (palette).type == LARGEITER                \
         ? intergray(i1, i2, n)                                                \
...
#define imgetpixel(image, x, y)                                                \
    ((image)->bytesperpixel == 1                                               \
         ...
         : ((image)->bytesperpixel == 4                                        \
                ? ((pixel32_t *)(image)->currlines[y])[x]                      \
                : (image)->bytesperpixel == 3                                  \
                      ? (((pixel16_t *)(image)->currlines[y])[x] +             \
                         ((image)->currlines[y][3 * (x) + 2] << 16))           \
                      : (((pixel16_t *)(image)->currlines[y])[x])))
struct requirements {
    int nimages;
    int supportedmask;
...
#define drivercall(i, x1, x2, x3, x4)                                          \
