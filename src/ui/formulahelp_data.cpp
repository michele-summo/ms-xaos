...
const struct formula_help_row formula_help_functions[] = {
    ...
    {"randsc", "seed; [size=1+i]; [degradation=0.5+0.5i]; [kaleidoscope=1]; [mode=0]; [radius=4]", "coherent noise over the point: soft blobs, size wide and size high", NULL},
    {"randscq", "seed; [size=1+i]; [degradation=0.5+0.5i]; [kaleidoscope=1]; [mode=0]; [radius=4]", "the same field with no interpolation: a mosaic of flat square cells", NULL},
    {"randscp", "seed; [size=1+i]; [degradation=0.5+0.5i]; [kaleidoscope=1]; [mode=0]; [radius=4]", "the same field cut into irregular flat polygons, with straight edges", NULL},
    {"randsch", "seed; [size=1+i]; [degradation=0.5+0.5i]; [kaleidoscope=1]; [mode=0]; [radius=4]", "the same field cut into hexagons: a honeycomb of flat cells", NULL},
    {"randsct", "seed; [size=1+i]; [degradation=0.5+0.5i]; [kaleidoscope=1]; [mode=0]; [radius=4]", "the same field cut into equilateral triangles, alternating in orientation", NULL},
