...
const struct formula_help_row formula_help_values[] = {
    ...
    {"0.02 to 0.05", "", "the useful range: every colouring mode is already at full variation here, and a square or hexagonal bailout still shows no change at all. The argument says which way across a cell the turn grows", NULL},
    {"larger", "", "free under a circular bailout at any value, but under a polygon it begins to move which cells leave: at 2+2i, two to seven per cent of the picture. Nothing is gained in colour by going past 0.05", NULL},
