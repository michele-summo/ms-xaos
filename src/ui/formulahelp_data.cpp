...
const struct formula_help_row formula_help_functions[] = {
    ...
    {"randsc", "seed, [size=1+i], [degradation=0.5+0.5i], [kaleidoscope=1], [mode=0], [skew=0], [skew_mode=0], [selfsim=off]", "coherent noise over the point: soft blobs, size wide and size high -- gradient noise, one octave of what fbm sums", NULL},
    {"randscq", "seed, [size=1+i], [degradation=0.5+0.5i], [kaleidoscope=1], [mode=0], [skew=0], [skew_mode=0], [selfsim=off]", "the same field with no interpolation: a mosaic of flat square cells", NULL},
...
const struct formula_help_row formula_help_values[] = {
    ...
    {"3", "", "hexagons", NULL},
    {"4", "", "octagons and squares (4.8.8)", NULL},
    {"5", "", "hexagons and triangles, the trihexagonal (3.6.3.6)", NULL},
    {"6", "", "hexagons, squares and triangles (3.4.6.4)", NULL},
    {"7", "", "dodecagons and triangles (3.12.12)", NULL},
    {"8", "", "dodecagons, hexagons and squares (4.6.12)", NULL},
    {"9", "", "rows of squares and of triangles (3.3.3.4.4)", NULL},
    {"10", "", "the snub square (3.3.4.3.4)", NULL},
    {"11", "", "the snub hexagonal, hexagons in a sea of triangles (3.3.3.3.6)", NULL},
    {"12", "", "tetrakis square: right triangles, eight round a point", NULL},
    {"13", "", "rhombille: rhombi that read as cubes", NULL},
    {"14", "", "deltoidal trihexagonal: kites", NULL},
    {"15", "", "triakis triangular: obtuse triangles", NULL},
    {"16", "", "kisrhombille: half-equilateral triangles, twelve round a point", NULL},
    {"17", "", "prismatic pentagons", NULL},
    {"18", "", "Cairo pentagons", NULL},
    {"19", "", "floret pentagons, six to a flower", NULL},
    {"20", "", "bricks, running bond", NULL},
    {"21", "", "Flemish bond: a brick and a half brick by turns", NULL},
    {"22", "", "herringbone", NULL},
    {"23", "", "basketweave", NULL},
    {"24", "", "Pythagorean: squares of two sizes", NULL},
    {"25", "", "chevrons", NULL},
    {"26", "", "squares and rhombi in alternate rows", NULL},
    {"27", "", "houses: a pentagon, up and hanging by turns", NULL},
    {"28", "", "rows: two of squares, one of triangles", NULL},
    {"29", "", "rows: one of squares, two of triangles", NULL},
    {"30", "", "hexagons among triangles", NULL},
    {"31", "", "Greek crosses", NULL},
    {"32", "", "T tetrominoes", NULL},
    {"33", "", "eight-pointed stars and crosses", NULL},
    {"34", "", "six-pointed stars and hexagons", NULL},
    {"35", "", "eight-pointed stars with four-pointed ones and rhombi", NULL},
    {"36", "", "twelve-pointed stars with three-pointed ones and rhombi", NULL},
    {"37", "", "twelve-pointed stars with notched hexagons and squares", NULL},
    {"38", "", "Voronoi cells, irregular -- randscp's", NULL},
    {"39", "", "Penrose rhombs: never repeats, fivefold", NULL},
    {"40", "", "Penrose kites and darts", NULL},
    {"41", "", "Ammann-Beenker: squares and rhombi, eightfold, never repeats", NULL},
    {"42", "", "rhombi in twelve directions, never repeats", NULL},
    {"43", "", "rhombi in seven directions, never repeats", NULL},
    {"44", "", "the pinwheel: triangles facing every way there is", NULL},
    {"45", "", "the chair: Ls cut into Ls", NULL},
    {"anything else", "", "nought, as a zero size gives", NULL},
    {NULL, NULL, NULL, "randsc family and the three figures: how many wedges the kaleidoscope folds the plane into. The fields fold the position; a figure has no use for it and reads z, the point it carries down towards the part it stands in, so that is what a figure folds"},
    ...
    {NULL, NULL, NULL, "randsc family and the three figures: which mirror the kaleidoscope folds with"},
    ...
    {"4", "", "across the wedge: a turn that follows where the point stands in its wedge of the kaleidoscope -- nothing on the edges of the wedge, the whole turn the imaginary part of the skew gives on its own down the middle (127 degrees for 2) -- the same in every wedge, so the picture stays a kaleidoscope, mirrors and all. Does nothing when nothing is folded, or when the imaginary part is nought", NULL},
    ...
    {"left out", "", "off: the one pass, to the bit -- what a call that says nothing gets, and a place left empty", NULL},
    {"0", "", "the plain average: every pass weighed alike, as a degradation of one weighs them, and what every H near nought gives. Not off", NULL},
