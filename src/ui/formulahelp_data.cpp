...
const struct formula_help_row formula_help_functions[] = {
    ...
    {"randsc", "seed, [size=1+i], [degradation=0.5+0.5i], [kaleidoscope=1], [mode=0], [skew=0], [skew_mode=0], [selfsim=off]", "coherent noise over the point: soft blobs, size wide and size high", NULL},
