...
const struct formula_help_row formula_help_functions[] = {
    ...
    {"snowflake", "[radius=4]", "the Koch snowflake, banded by generation: a child sits on an edge of its parent, so the step onto the parent turns it as well as blowing it up by three. The ground it leaves in the corners of the hexagon goes on the first pass and the body on the second", NULL},
