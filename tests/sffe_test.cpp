...
static const testcase cases[] = {
    ...
    T_VAL("conj({3,4})", 3, -4, "conj negates the imaginary part"),
    T_VAL("conj(z)", 2, 0, "...and leaves a real argument alone"),
    T_VAL("rect({1,2},{3,4})", 1, 4, "rect takes real from a, imaginary from b"),
    T_VAL("polar({8,0},{0,3})", 0, 8, "polar takes the modulus from a, angle from b"),
    T_VAL("polar({0,3},{8,0})", 3, 0, "...and the other way round"),
